...
internal sealed class FormShowMatHistogramDemo : Form
{
    ...
    private static void ShowGrayAlignedDemo()
    {
        ...
        image.ShowWithHistogram("Show(Mat) - CV_8UC1 aligned");
    }
    ...
    private static void ShowGrayUnalignedDemo()
    {
        ...
        image.ShowWithHistogram("Show(Mat) - CV_8UC1 unaligned");
    }
    ...
    private static void ShowColorAlignedDemo()
    {
        ...
        image.ShowWithHistogram("Show(Mat) - CV_8UC3 aligned");
    }
    ...
    private static void ShowColorUnalignedDemo()
    {
        ...
        image.ShowWithHistogram("Show(Mat) - CV_8UC3 unaligned");
    }
    ...
    private static void ShowArgbDemo()
    {
        ...
        image.ShowWithHistogram("Show(Mat) - CV_8UC4 ARGB");
    }
    ...
    private static void ShowSubMatDemo()
    {
        ...
        subMat.ShowWithHistogram("Show(Mat) - sub-mat ROI");
    }
